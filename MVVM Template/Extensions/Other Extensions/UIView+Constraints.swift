...
private var vTopCornerRadius: CGFloat = 0.0
private var vBottomCornerRadius: CGFloat = 0.0
...
//        get {
//            return vBottomCornerRadius
//        }
//        set {
////            round(corners: [.bottomLeft, .bottomRight], radius: newValue)
...
//        get {
//            return vTopCornerRadius
//        }
//        set {
//            round(corners: [.topLeft, .topRight], radius: newValue)
//
////            if cornerRadius > 0 {
////                cornerRadius = 0.0
////            }
...
////                cornerRadius = topCornerRadius
////                bottomCornerRadius = 0.0
////            } else {
//                vTopCornerRadius = newValue
////            }
//
////            self.setNeedsLayout()
//
...
extension UIViewController {
    ...
    func getVC(vcIdentifier : String, inStoryBboard storyboard: Storyboards) -> UIViewController {
        //String = kStoryBoardMain
        return UIStoryboard(name: storyboard.rawValue, bundle: nil).instantiateViewController(withIdentifier: vcIdentifier)
    }
